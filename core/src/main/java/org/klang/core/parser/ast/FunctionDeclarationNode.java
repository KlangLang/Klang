...
public class FunctionDeclarationNode extends StatementNode {
    ...
    public FunctionDeclarationNode(AccessModifier access, Token returnType, Token name, List<ParameterNode> parameters, BlockStatementNode body, int line, int column){
        super(line, column);
        this.access = access;
